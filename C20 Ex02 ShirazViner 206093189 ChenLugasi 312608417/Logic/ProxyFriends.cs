...
namespace Logic
{
    ...
    public sealed class ProxyFriends
    {
        ...
        public List<User> MenFriends
        {
            get;
            private set;
        }

        public List<User> WomenFriends
        {
            get;
            private set;
        }
        ...
        private void fetchFriends()
        {
            ...
            {
                MessageBox.Show("Friends List - permission error !!!!");
            }
        }
        ...
        public List<User> GetUserListByGender(eGender i_PnaelChoice)
        {
            UpdateFriendsList();
